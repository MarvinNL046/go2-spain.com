  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" href="/go2spain-favicon.webp" />
        <link rel="apple-touch-icon" href="/go2spain-favicon.webp" />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "logo": "https://go2-spain.com/go2spain-favicon.webp",
              "description": "Your comprehensive guide to Spain travel",
              "contactPoint": {
                "@type": "ContactPoint",
                "email": "info@go2-spain.com",
