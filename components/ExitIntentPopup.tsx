      ...
      >
        ...
        {status === 'success' ? (
          <div className="text-center py-4">
            ...
            <p className="text-gray-600 text-sm">Check your inbox for Spain travel tips.</p>
          </div>
        ) : (
          <>
            {/* Icon */}
            <div className="w-14 h-14 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-5">
              <svg className="w-7 h-7 text-spain-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-gray-600 text-sm text-center mb-6">
              Get free Spain travel tips, hidden gems, and budget hacks straight to your inbox. No spam, unsubscribe anytime.
            </p>
            ...
            <form onSubmit={handleSubscribe} className="space-y-3">
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 text-sm focus:outline-none focus:border-spain-red focus:ring-1 focus:ring-spain-red transition-colors"
                autoFocus
              />
              <button
                type="submit"
                disabled={status === 'loading'}
                className="w-full py-3 bg-spain-red text-white rounded-xl text-sm font-semibold hover:bg-spain-red-600 transition-colors disabled:opacity-50"
              >
            ...
            <p className="text-gray-400 text-xs text-center mt-4">
              Join 1,000+ Spain travelers. Unsubscribe anytime.
            </p>
          </>
        )}
      </div>
